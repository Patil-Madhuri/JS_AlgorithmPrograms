...
function askArrayElements() {
    if(arrayElements.length == arraySize) {
        console.log("Menu : ");
        console.log("1. bubbleSort method for integer");
        console.log("2. bubbleSort method for String");
        read.question("Enter Choice : ",(choice) => {
            if(choice ==1) {
                /*
                 * Function to perform bubble sort for Integer.
                 * prints the sorted array.
                 * 
                 */
                var array1 = common.bubbleSortInteger(arrayElements,arraySize);
		        console.log("Sorted bubble Sort Array : ");
                for(var index=0;index<arraySize;index++)
                    console.log(array1[index]);
            } else if(choice == 2) {
                /*
                 * Function to perform bubble sort for String.
                 * prints the sorted array.
                 * 
                 */
                var array1 = common.bubbleSortString(arrayElements,arraySize);
		        console.log("Sorted bubble Sort Array : ");
                for(var index=0;index<arraySize;index++)
                    console.log(array1[index]);
            }
